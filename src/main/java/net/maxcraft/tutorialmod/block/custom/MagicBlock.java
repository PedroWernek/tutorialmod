package net.maxcraft.tutorialmod.block.custom;
...
public class MagicBlock extends Block {
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        if(!world.isClient) {
            ...
            Box box = new Box(topPos);

            List<ItemEntity> entities = world.getEntitiesByClass(ItemEntity.class, box, entity -> true);
    ...
    /*@Override
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        if(entity instanceof ItemEntity itemEntity && state.get(ACTIVATED)){
